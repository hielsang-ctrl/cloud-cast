(function (global) {
    ...
    const cities = { nairobi: { name: "Nairobi, Kenya", lat: -1.2864, lon: 36.8172 }, eldoret: { name: "Eldoret, Kenya", lat: 0.5143, lon: 35.2698 }, kisumu: { name: "Kisumu, Kenya", lat: -0.0917, lon: 34.768 }, nakuru: { name: "Nakuru, Kenya", lat: -0.3031, lon: 36.08 } };
